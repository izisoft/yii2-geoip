...
class CGeoIP extends Component {
    ...
    public $cityDbPath = '@vendor/izisoft/yii2-geoip/components/db/GeoLite2-City.mmdb';
    
    public $countryDbPath = '@vendor/izisoft/yii2-geoip/components/db/GeoLite2-Country.mmdb';
